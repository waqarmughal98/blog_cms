...
<div class="blog_main_wrapper">
	<div class="blog_top_header_wrapper">
		...
		<div class="blog_tranding_slider">
			<crypto-widget type="ticker-quotes" template="basic" color="yellow" assets="BTC~USD,ETH~USD,LTC~USD,DASH~USD,XRP~USD,USDT~USD,ETC~USD,BTG~USD,XMR~USD" speed="100" direction="left" pause="true" api="cryptocompare.com" realtime="true" animation="flash"></crypto-widget>
		</div>
