									...
									<div class="blog_travel_slider">
										<div class="swiper-container">
											<div class="swiper-wrapper">
												<div class="swiper-slide">
												<?php
													$selcat2 = "SELECT * FROM `posts` WHERE domain='$domain' LIMIT 2";
													$queries->query($selcat2);
													if($queries->count() > 0):
														while($row2 = $queries->fetch()):
															$id = $row2->id;
												...
												<div class="swiper-slide">
												<?php
												$getPost = "SELECT * FROM `posts` WHERE `category_id`='new' LIMIT 5";
												$queries->query($getPost);
												if($queries->count() > 0):
													$row = $queries->fetchAll();
													unset($row[0]);
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-12">
										<div class="blog_technology_slider">
											<div class="swiper-container">
												<div class="swiper-wrapper">
												<?php
													$selcat2 = "SELECT * FROM `posts` WHERE domain='$domain' LIMIT 4";
													$queries->query($selcat2);
													if($queries->count() > 0):
														while($row2 = $queries->fetch()):
															$id = $row2->id;
