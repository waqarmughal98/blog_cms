			...
			<div class="page-wrapper">
				<div class="container-fluid">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name="cate_name" id="firstName" class="form-control" placeholder="Enter Category Name">
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
                    ...
                    if(isset($_POST['submit-category'])):
                        ...
                        $insertCate = "INSERT INTO categories (`category_name`,`seo_url`,`domain`) VALUES (?,?,?)";
                        $values = [$cateName,$url,$domain];
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-default card-view mt-50">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark">All Catgories</h6>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="panel-wrapper collapse in">
                                            ...
                                            <div>
                                                <form action="" method="POST">
                                                    <table class="tablesaw table-striped table-hover table-bordered table" data-tablesaw-mode="columntoggle">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Catgories Name</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <?php
                                                            $selectcat = "SELECT * FROM `categories` WHERE domain='$domain'";
